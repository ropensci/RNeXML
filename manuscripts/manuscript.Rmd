...
that largely defeat the advantages of a shared standard file format.
NeXML was developed to addresses each of these problems `r citep("Vos NeXML Systematic Biology")`  
by drawing on state-of-the-art data management technology.
...
but inherits the limiations of the NEXUS format.  
...
of R packages currently avaliable for handling phylogenetic data  
