...
a sizable number of TreeBASE NEXUS
files could not be read in this way <!-- CB to rephrase to make a -->
<!-- broader point and refer back to arguments made in the NeXML -->
<!-- paper, possibly moving this larger point to the introduction -->.  Owing to the syntactically strict
definition of the
NeXML standard, the RNeXML package can successfully read every 
NeXML document from TreeBASE.
