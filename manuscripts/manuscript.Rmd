...
abstract: | 
      ...
      4. RNeXML is perfectly suited for users to preserve and maintain their
...
4) Accessing / opening up existing rich NeXML data to the R user
...
* Why NeXML -- because the NEXUS standard isn't a standard.  Developers extend
...
```{r include=FALSE}
# remove external NeXML files created by running this vignette
unlink("simmap.xml")
unlink("birds.xml")
unlink("geospiza.xml")
unlink("rdf_meta.xml")
