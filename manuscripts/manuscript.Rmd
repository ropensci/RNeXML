...
continuous type (for many trait data).  Similarly as for trees, data
matrices can also be arranged in blocks; in fact, matrices of
different data types are required to be separated into different
"blocks" to allow strict validation of data typs. Since the
`data.frame` data structure in R has no such constraints, the
