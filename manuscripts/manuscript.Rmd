...
<!-- FIXME it would be nice if we had a more persuasive example here. directly getting the value
...
to fire up protege (let's not!). As it happens, the Dublin Core URI, 
