...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={RNeXML: Parsing and Serializing the Next Generation of Phyloinformatic Data in R},
            colorlinks=true,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\begin{figure}[htbp]
\centering
\includegraphics{components/figure/manuscript-unnamed-chunk-31.pdf}
...
1.0-2. The current development branch can be found on Github at
