...
- [A Brief Introduction to RNeXML](https://ropensci.github.com/RNeXML/articles/intro)
- [RNeXML: A Package for Reading and Writing Richly Annotated Phylogenetic, Character, and Trait Data in R](https://ropensci.github.com/RNeXML/articles/manuscript.pdf) (published in MEE).
- [Handling Metadata in RNeXML](https://ropensci.github.com/RNeXML/articles/metadata)
- [The `nexml` S4 Object](https://ropensci.github.com/RNeXML/articles/S4)
- [Semantic data & SPARQL with RNeXML](https://ropensci.github.com/RNeXML/articles/SPARQL)
- [Extending NeXML: an example based on simmap](https://ropensci.github.com/RNeXML/articles/simmap)
