...
- [RNeXML: A Package for Reading and Writing Richly Annotated Phylogenetic, Character, and Trait Data in R](https://docs.ropensci.org/RNeXML/articles/manuscript.pdf) (published in MEE).
