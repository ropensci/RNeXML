...
test_that("ape files write to nexml files correctly, set 3", {
  ...
  expect_is(nexml_read("~/one_q.xml"), "phylo")
  expect_is(nexml_read("~/two_q.xml"), "phylo")
  expect_is(nexml_read("~/three_q.xml"), "phylo")
  expect_is(nexml_read("~/four_q.xml"), "phylo")
  expect_is(nexml_read("~/five_q.xml"), "phylo")
  expect_is(nexml_read("~/six_q.xml"), "phylo")
})